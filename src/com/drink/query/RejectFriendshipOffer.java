...
public class RejectFriendshipOffer extends WebQuery {

	public RejectFriendshipOffer(Context context, String friend_user_id) {

		mURLBuilder.setPath("friends/rejectFriendshipOffer");
